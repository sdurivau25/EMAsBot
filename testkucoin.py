...
client = Client('5e9f0ee67814480008a5a0d7', 'b637595c-6b30-413d-9b53-5660b067d875', 'Stan2802')
client1 = Client('5eb01f7881f0410008c53413', '088d187c-a011-4d83-a487-e0c186427ab0', 'jbbot2020')


class Indicators(Thread):
    """Indicators from Kucoin's price"""
    
    def __init__(self, paire, client=client1):
    ...
    def telegram_bot_sendtext(self, bot_message):
        self.bot_token = '1059970605:AAEjVuUi3wB4UyNXdz8vcRpCNm5HDk81X8Y'
        self.send_text = 'https://api.telegram.org/bot' + self.bot_token + '/sendMessage?chat_id=' + '1148095114' + '&parse_mode=Markdown&text=' + bot_message
    ...
    def run(self):
        while True :
            ...
            self.telegram_bot_sendtext(self.ema20)
            self.telegram_bot_sendtext(self.ema45)
            self.telegram_bot_sendtext(self.ema130)
            sleep(5)

indic = Indicators('ETH-USDT', client1)
indic.start()
